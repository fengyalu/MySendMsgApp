package cn.com.fyl.learn.mysendmsgapp.view;
...
//    private TextView mTvHourUnit, mTvMinuteUnit;
    ...
    public interface BeginTimeCallBack {
        void onTimeBegin(long beginTimes);
    }

    public interface EndTimeCallBack {
        void onTimeEnd(long endTimes);
    }
     ...
     */
    public TimePicker(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
//    public TimePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
...
//    }
    ...
    private void initView() {
        ...
        mPickerDialog.findViewById(R.id.left).setOnClickListener(this);
        mPickerDialog.findViewById(R.id.right).setOnClickListener(this);
        ...
        mDpvYear = (PickerView) mPickerDialog.findViewById(R.id.pickview_year);
        mDpvYear.setOnSelectListener(this);
        mDpvMonth = (PickerView) mPickerDialog.findViewById(R.id.pickview_mounth);
        mDpvMonth.setOnSelectListener(this);
        mDpvDay = (PickerView) mPickerDialog.findViewById(R.id.pickview_day);
        mDpvDay.setOnSelectListener(this);
        mDpvHour = (PickerView) mPickerDialog.findViewById(R.id.pickview_hour);
        mDpvHour.setOnSelectListener(this);
        mDpvMinute = (PickerView) mPickerDialog.findViewById(R.id.pickview_minute);
        mDpvMinute.setOnSelectListener(this);
        mDpvSecond = (PickerView) mPickerDialog.findViewById(R.id.pickview_second);
    ...
    private void initDateUnits(int endMonth, int endDay, int endHour, int endMinute, int mEndSecond) {
        ...
        if ((mScrollUnits & SCROLL_UNIT_SECOND) != SCROLL_UNIT_SECOND) {
            ...
            for (int i = mBeginSecond; i <= endMinute; i++) {
    ...
    private void linkageSecondUnit(final boolean showAnim) {
        if ((mScrollUnits & SCROLL_UNIT_MINUTE) == SCROLL_UNIT_MINUTE) {
            ...
            int selectedSecond = getValueInRange(mSelectedTime.get(Calendar.MINUTE), minSecond, maxSecond);
